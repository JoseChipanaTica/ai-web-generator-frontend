...
const SectionSix = ({
    ...
    return (
        <div className="flex flex-col min-h-[800px] justify-center items-center p-2">
            <div
                className="w-3/4 md:w-[600px] flex flex-col items-center justify-center  h-[500px] border-2 shadow-2xl border-black rounded-xl   ">
                <div>
                ...
                <div className="text-3xl p-4 font-bold h-[200px] flex flex-col justify-center items-center">
                    <h1 className="text-base">{block[0].value}</h1>
                </div>
